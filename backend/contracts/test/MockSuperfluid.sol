...
import {Superfluid, ISuperApp} from "@superfluid-finance/ethereum-contracts/contracts/superfluid/Superfluid.sol";
...
contract SuperfluidUpgradabilityTester is Superfluid {
    ...
    function validateStorageLayout() external pure {
        ...
        assembly {
            slot := _appKeysUsed.slot
            offset := _appKeysUsed.offset
        }
...
contract MockSuperfluid is Superfluid {
